...
CREATE INDEX IF NOT EXISTS idx_transfer_execution_task_created_at ON transfer_execution_records (task_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_transfer_execution_status ON transfer_execution_records (status);
